...
import { CheckResetPasswordToken, isAuthenticated, isNotAuthenticated, ResetWithKForgottenPassword } from "../services/authentication.js";
...
userRouter.post('/reset-password', isNotAuthenticated, ResetWithKForgottenPassword)